...
RandomMovement::RandomMovement(std::shared_ptr<Entity> entity,Point p, bool collidable):
...
void RandomMovement::tryToMove(double time, std::vector<std::shared_ptr<Entity> > otherEntities){
    tick(time);
    m_movement_counter++;
